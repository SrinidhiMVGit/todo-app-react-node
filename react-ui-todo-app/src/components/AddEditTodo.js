            ...
            <div className="row">
                <div className="col-md-7  p-t-50">
                    ...
                    <div className="row m-bt-10">
                        <div className="col-12">
                        <Button onClick={this.handleSubmit(taskId)}  color="primary" style={{marginRight: 10}}> { !!taskId ? "Update" : "Add"}</Button>
                        
                           <Link className="no-text-decoration" to="/"><Button > Cancel</Button></Link>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(AddEditTodo));